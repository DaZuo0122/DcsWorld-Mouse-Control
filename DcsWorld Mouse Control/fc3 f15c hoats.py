# this script match fc3 f15c best
# vjoy z axis haven't been actived yet
# Note: to enable hoats, u need to delet arrow in f15c setting
import ctypes
...
class radar():
	def __init__(self,radar_open):
		self.open = radar_open
...
# click mouse1 to enable VSD control, click it again to disable
# vsd_active = mouse.getPressed(0)
...
if IsActive.btn :
	...
	vJoy[0].setButton(7, mouse.getPressed(0))
